...
export const allProgrammes: Programme[] = [
  ...
  },
  {
    ...
    duration: '3 mois',
    format: 'Blended',
    price: { amount: 1374, currency: 'EUR' },
  ...
  },
  {
    ...
    duration: '3 mois',
    format: 'Blended',
    price: { amount: 1221, currency: 'EUR' },
    nextSession: '2026-11-01',
    enrollmentStatus: 'coming_soon',
    badge: null,
  ...
  },
  {
    ...
    duration: '3 mois',
    format: 'Blended',
    price: { amount: 1298, currency: 'EUR' },
    nextSession: '2026-12-01',
    enrollmentStatus: 'coming_soon',
    badge: 'Nouveau',
  ...
  // ============================================================
  {
    ...
    duration: '6 mois',
    format: 'Blended',
    price: { amount: 2290, currency: 'EUR' },
    nextSession: '2026-09-01',
    enrollmentStatus: 'open',
    badge: 'Populaire',
    imageGradient: 'from-blue-900 to-slate-900',
  ...
  // ============================================================
  {
    ...
    duration: '12 mois',
    format: 'Blended',
    price: { amount: 4275, currency: 'EUR' },
  ...
  },
  {
    ...
    duration: '8 semaines',
    format: 'Blended',
    price: { amount: 1832, currency: 'EUR' },
    nextSession: '2026-10-01',
    enrollmentStatus: 'open',
    badge: null,
    imageGradient: 'from-orange-900 to-slate-900',
  ...
  },
  {
    ...
    duration: '6 semaines',
    format: 'En ligne',
    price: { amount: 1145, currency: 'EUR' },
...
export const events: EventData[] = [
  {
    ...
    city: 'Abidjan',
    rector: { name: 'M. Siandou FOFANA', title: 'Ancien Ministre du Tourisme et des Loisirs — Recteur Honorifique' },
    stats: { participants: '300+', speakers: 18, duration: '1 journée' },
    description: "La 1ère Université Africaine du Tourisme est le premier grand forum continental dédié au développement du tourisme en Afrique de l'Ouest. Organisée par ETHSUN Institute sous l'égide de son Recteur Honorifique M. Siandou FOFANA, cette édition inaugurale rassemble décideurs publics, investisseurs, opérateurs touristiques et institutions académiques autour d'une vision commune : faire du tourisme africain un levier de croissance économique durable. L'événement est placé sous le signe de l'action collective, de l'innovation et de la diplomatie touristique.",
    objectives: [
      "Créer une plateforme de dialogue entre acteurs publics, privés et académiques du tourisme africain",
      "Identifier les leviers de compétitivité touristique pour l'Afrique de l'Ouest",
      "Promouvoir l'investissement hôtelier et le développement des infrastructures touristiques",
      "Mettre en lumière les opportunités du tourisme durable, culturel et de l'écotourisme",
      "Proposer des recommandations concrètes aux gouvernements et institutions de développement",
      "Valoriser les métiers du tourisme et encourager la formation professionnelle dans le secteur"
    ],
    targetAudience: "Ministres et cadres des ministères du tourisme, directeurs généraux d'offices du tourisme, investisseurs et promoteurs hôteliers, tour-opérateurs et agences de voyage, directeurs d'établissements hôteliers, universitaires et chercheurs en tourisme, journalistes spécialisés, alumni ETHSUN Institute.",
    schedule: [
      { time: '08h00', title: 'Accueil et enregistrement des participants — Hall Sofitel' },
      { time: '09h00', title: 'Cérémonie d\'ouverture officielle — Allocutions des autorités' },
      { time: '09h30', title: 'Discours inaugural du Recteur Honorifique M. Siandou FOFANA' },
      { time: '10h00', title: 'Panel 1 : Tourisme durable en Afrique de l\'Ouest — Défis, opportunités et financements innovants' },
      { time: '11h30', title: 'Panel 2 : Investissement hôtelier, infrastructures touristiques et partenariats public-privé' },
      { time: '12h30', title: 'Pause déjeuner de networking — Terrasse Sofitel' },
      { time: '14h00', title: 'Atelier A : Tourisme digital — plateformes, e-réputation et marketing territorial' },
      { time: '14h00', title: 'Atelier B : Écotourisme et tourisme communautaire — modèles africains inspirants' },
      { time: '14h00', title: 'Atelier C : Formation et professionnalisation des métiers du tourisme' },
      { time: '16h00', title: 'Restitution des ateliers — Recommandations et feuille de route commune' },
    ...
    partners: [
      ...
      'Association des Hôteliers de Côte d\'Ivoire',
    ],
  },
  {
    title: '6ème Université de l\'Immobilier',
    ...
    venue: 'Sofitel Hôtel Ivoire',
    city: 'Abidjan',
    rector: { name: 'M. Bruno Nabagné KONÉ', title: 'Ministre de la Construction, du Logement et de l\'Urbanisme — Recteur Honorifique' },
    stats: { participants: '400+', speakers: 25, duration: '2 jours' },
    description: "La 6ème Université de l'Immobilier est le rendez-vous incontournable des professionnels de l'immobilier en Afrique de l'Ouest. Organisée depuis 2018 par ETHSUN Institute, cette édition 2026 se tient sous le haut patronage de M. Bruno Nabagné KONÉ, Ministre de la Construction, du Logement et de l'Urbanisme, et rassemble promoteurs, investisseurs, juristes, experts fonciers et cadres de l'administration autour des grands enjeux immobiliers du continent. Au programme : exposition immobilière, séminaires de haut niveau, networking d'élite et cérémonie de graduation CAPIMMO.",
    objectives: [
      "Réunir l'écosystème immobilier ouest-africain : acteurs publics, privés et académiques",
      "Débattre des défis de financement, de régulation foncière et d'urbanisme durable",
      "Présenter les innovations PropTech et les nouvelles tendances du marché immobilier africain",
      "Valoriser les lauréats CAPIMMO lors de la cérémonie de graduation officielle",
      "Favoriser les partenariats et opportunités d'investissement dans l'immobilier régional",
      "Proposer des recommandations aux pouvoirs publics sur le logement social et l'habitat durable"
    ],
    targetAudience: "Promoteurs immobiliers, agents immobiliers, notaires et juristes fonciers, cadres des ministères de la construction et du logement, directeurs de banques et établissements de crédit immobilier, architectes et urbanistes, investisseurs institutionnels, lauréats CAPIMMO, étudiants et professionnels en reconversion immobilière.",
    schedule: [
      { time: 'JOUR 1 — 21 juin 2026', title: '— Séminaires, Exposition & Networking' },
      { time: '08h00', title: 'Ouverture de l\'exposition immobilière — Stands des promoteurs et partenaires' },
      { time: '09h00', title: 'Cérémonie d\'ouverture officielle sous la présidence de M. Bruno Nabagné KONÉ' },
      { time: '09h45', title: 'Discours inaugural du Recteur Honorifique' },
      { time: '10h30', title: 'Panel 1 : Financement du logement en Afrique de l\'Ouest — Accès au crédit, fonds de garantie et innovations financières' },
      { time: '12h00', title: 'Panel 2 : Régulation foncière, sécurisation des titres et réformes institutionnelles' },
      { time: '13h00', title: 'Déjeuner de networking VIP — Espace Business Sofitel' },
      { time: '14h30', title: 'Atelier A : Gestion locative et property management — bonnes pratiques africaines' },
      { time: '14h30', title: 'Atelier B : Promotion immobilière — du foncier à la commercialisation' },
      { time: '14h30', title: 'Atelier C : PropTech & Digital — innovations qui transforment l\'immobilier africain' },
      { time: '16h30', title: 'Restitution des ateliers — Synthèse et recommandations' },
      { time: '17h30', title: 'Cocktail de networking et visite de l\'exposition immobilière' },
      { time: 'JOUR 2 — 22 juin 2026', title: '— Graduation CAPIMMO & Clôture' },
      { time: '09h00', title: 'Panel 3 : Immobilier durable — Construction verte, efficacité énergétique et habitat africain du futur' },
      { time: '10h30', title: 'Panel 4 : Investissement immobilier — Stratégies, rendements et gestion des risques en Afrique' },
      { time: '12h00', title: 'Déjeuner de gala — Espace Panoramique Sofitel' },
      { time: '14h00', title: 'Cérémonie de Graduation CAPIMMO — 18ème Promotion' },
      { time: '14h30', title: 'Remise officielle des Certificats d\'Aptitude aux Professions Immobilières' },
      { time: '15h30', title: 'Allocution des lauréats et témoignages' },
    ...
    partners: [
      ...
      'Chambre Nationale des Agents Immobiliers de Côte d\'Ivoire (CNAI-CI)',
      'ETHSUN Executive Education Oxford',
      'Conseil National de l\'Ordre des Architectes de Côte d\'Ivoire',
      'Fonds de Développement du Logement Social',
      'Association des Promoteurs Immobiliers de Côte d\'Ivoire',
    ],
  },
  {
    title: '3ème Université de l\'Éthique et la Gouvernance des Services Publics',
    slug: 'universite-ethique-gouvernance',
    date: '2026-07-18',
    venue: 'Sofitel Hôtel Ivoire',
    city: 'Abidjan',
    rector: { name: 'M. Épiphane ZORO BI BALO', title: 'Président de la Haute Autorité pour la Bonne Gouvernance (HABG) — Recteur Honorifique' },
    stats: { participants: '350+', speakers: 22, duration: '1 journée' },
    description: "La 3ème Université de l'Éthique et la Gouvernance des Services Publics est le forum de référence en Afrique de l'Ouest sur les questions d'intégrité publique, de lutte contre la corruption et de modernisation de l'État. Placée sous la présidence de M. Épiphane ZORO BI BALO, Président de la Haute Autorité pour la Bonne Gouvernance (HABG), cette édition 2026 aborde les thématiques prioritaires de gouvernance foncière, de régulation de l'électricité et de conformité institutionnelle. L'événement réunit hauts fonctionnaires, magistrats, responsables d'institutions indépendantes, experts en compliance et acteurs de la société civile.",
    objectives: [
      "Promouvoir une culture de l'intégrité, de la transparence et de la redevabilité dans les institutions publiques",
      "Analyser les mécanismes de lutte contre la corruption et les dispositifs de prévention des conflits d'intérêts",
      "Débattre des enjeux de gouvernance foncière et de sécurisation du patrimoine public",
      "Explorer les défis de régulation du secteur de l'électricité et des services essentiels",
      "Renforcer les capacités des acteurs institutionnels en matière de conformité et d'éthique professionnelle",
      "Formuler des recommandations concrètes à l'intention des gouvernements et institutions de contrôle"
    ],
    targetAudience: "Hauts cadres de l'administration publique, directeurs généraux d'établissements publics, magistrats et membres de juridictions de contrôle, responsables de la conformité et du contrôle interne, membres d'institutions indépendantes (HABG, IGE, ANLC), représentants de la société civile et ONG, journalistes d'investigation, responsables RH et formation des ministères.",
    schedule: [
      { time: '08h00', title: 'Accueil et enregistrement des participants' },
      { time: '09h00', title: 'Cérémonie d\'ouverture officielle sous la présidence de M. Épiphane ZORO BI BALO' },
      { time: '09h30', title: 'Discours inaugural du Recteur Honorifique — État de la gouvernance en Afrique de l\'Ouest' },
      { time: '10h15', title: 'Panel 1 : Lutte contre la corruption — Progrès, lacunes et nouvelles frontières en Afrique subsaharienne' },
      { time: '11h45', title: 'Panel 2 : Gouvernance foncière — Sécurisation des droits, transparence cadastrale et conflits fonciers' },
      { time: '13h00', title: 'Déjeuner de networking' },
      { time: '14h30', title: 'Panel 3 : Régulation de l\'électricité — Gouvernance, accès universel et transition énergétique' },
      { time: '15h45', title: 'Atelier A : Compliance et contrôle interne dans les institutions publiques — outils et méthodes' },
      { time: '15h45', title: 'Atelier B : Protection des lanceurs d\'alerte et accès à l\'information publique' },
      { time: '17h00', title: 'Restitution des ateliers — Déclaration finale et recommandations institutionnelles' },
    ...
    partners: [
      ...
      'Autorité Nationale de Régulation du Secteur de l\'Électricité (ANARE)',
  ...
  {
    title: 'CAPIMMO — 18ème Promotion',
    slug: 'capimmo-18eme-promotion',
    date: '2026-09-01',
    venue: 'ETHSUN Institute — Learning Center & Sofitel Hôtel Ivoire (présentiel)',
    city: 'Abidjan',
    stats: { participants: '30', speakers: 12, duration: '8 semaines' },
    price: { amount: 1298, currency: 'EUR', note: 'Frais de formation. Frais d\'inscription : 305 EUR (non remboursables). Paiement en 2 tranches possible.' },
    description: "Le Certificat d'Aptitude aux Professions Immobilières (CAPIMMO) est le titre professionnel de référence en Côte d'Ivoire pour les acteurs de l'immobilier. Dispensée en format blended (présentiel à Abidjan + en ligne), la 18ème Promotion s'adresse aux professionnels souhaitant formaliser leurs compétences immobilières, aux reconvertis du secteur et aux porteurs de projets immobiliers. La sélection se fait sur dossier. Le titre « Certificat d'Aptitude aux Professions Immobilières » est délivré aux candidats ayant réussi les épreuves d'évaluation.",
    objectives: [
      "Maîtriser le cadre juridique et réglementaire de l'immobilier en Côte d'Ivoire et en Afrique de l'Ouest",
      "Acquérir les techniques d'évaluation, de négociation et de commercialisation immobilière",
      "Comprendre les mécanismes de financement du logement et de l'investissement immobilier",
      "Développer des compétences en gestion locative, copropriété et property management",
      "Maîtriser les fondamentaux de la promotion immobilière et de la gestion de projets de construction",
      "Intégrer les outils digitaux et PropTech dans la pratique professionnelle immobilière",
      "Préparer et réussir les épreuves d'obtention du titre CAPIMMO"
    ],
    targetAudience: "Agents immobiliers en exercice souhaitant obtenir une certification officielle, professionnels en reconversion vers l'immobilier, promoteurs et investisseurs immobiliers, cadres bancaires spécialisés en crédit immobilier, gestionnaires de patrimoine immobilier, architectes et ingénieurs souhaitant élargir leurs compétences commerciales.",
    modules: [
      { title: 'Module 1 — Droit immobilier et cadre réglementaire', description: 'Régime foncier ivoirien, titres de propriété, avant-contrats, actes de vente, baux commerciaux et résidentiels, réglementation des agents immobiliers.' },
      { title: 'Module 2 — Urbanisme et droit de la construction', description: "Plan d'urbanisme, permis de construire, normes de construction, règles d'alignement, servitudes, contentieux de voisinage." },
      { title: 'Module 3 — Évaluation et expertise immobilière', description: "Méthodes d'évaluation (comparaison, capitalisation, coût de remplacement), rapport d'expertise, due diligence immobilière, analyse de marché." },
      { title: 'Module 4 — Financement de l\'immobilier', description: "Crédit immobilier, fonds de garantie, dispositifs d'accession à la propriété, montage financier de projets, financement islamique de l'immobilier." },
      { title: 'Module 5 — Techniques de vente et négociation immobilière', description: "Prospection, prise de mandat, techniques de closing, gestion de la relation client, marketing immobilier, outils CRM." },
      { title: 'Module 6 — Gestion locative et administration de biens', description: "Baux d'habitation et commerciaux, quittancement, états des lieux, contentieux locatif, gestion des charges de copropriété." },
      { title: 'Module 7 — Promotion immobilière et montage de projet', description: "Faisabilité d'une opération immobilière, bilan promoteur, relations avec les entreprises de BTP, commercialisation sur plan (VEFA)." },
      { title: 'Module 8 — PropTech & Digital Immobilier', description: "Plateformes de vente en ligne, visite virtuelle 3D, BIM, gestion numérique des actifs immobiliers, marketing digital appliqué à l'immobilier." },
      { title: 'Module 9 — Fiscalité et comptabilité immobilière', description: "Taxes foncières, droits de mutation, TVA immobilière, comptabilité d'une agence immobilière, optimisation fiscale des investissements." },
      { title: 'Module 10 — Déontologie, éthique et pratique professionnelle', description: "Code de déontologie des agents immobiliers, lutte contre le blanchiment, LCBFT, gestion des conflits d'intérêts, responsabilité professionnelle." },
    ],
    schedule: [
      { time: 'Semaines 1–2', title: 'Modules 1 & 2 — Droit immobilier, urbanisme et cadre réglementaire (présentiel & en ligne)' },
      { time: 'Semaines 3–4', title: 'Modules 3 & 4 — Évaluation immobilière et financement (présentiel & en ligne)' },
      { time: 'Semaines 5–6', title: 'Modules 5, 6 & 7 — Vente, gestion locative, promotion immobilière (présentiel & en ligne)' },
  ...
  {
    title: 'Graduation Day ETHSUN 2026 — Cérémonie de Remise des Certificats',
    slug: 'graduation-day',
    date: '2026-12-12',
    venue: 'Sofitel Hôtel Ivoire',
    city: 'Abidjan',
    stats: { participants: '600+', speakers: 8, duration: '1 journée' },
    description: "Le Graduation Day ETHSUN est la cérémonie annuelle de remise des certificats et diplômes aux lauréats des programmes ETHSUN Institute. Moment fort de l'année académique, il réunit diplômés, familles, partenaires institutionnels et intervenants dans une célébration de l'excellence et de l'engagement. La cérémonie 2026 marque une étape historique pour l'Institut avec la remise des premiers Executive CBA — Certificate of Business Administration — aux côtés des promotions CAPIMMO, Gouvernance, Immobilier, Éthique et Gestion d'Entreprise.",
    objectives: [
      "Célébrer et officialiser la réussite des lauréats de toutes les promotions 2026",
      "Remettre solennellement les certificats, diplômes et distinctions d'excellence",
      "Renforcer le sentiment d'appartenance à la communauté alumni ETHSUN",
      "Valoriser les parcours individuels et les témoignages d'impact professionnel",
      "Créer un moment de networking entre alumnis, entreprises et partenaires institutionnels"
    ],
    targetAudience: "Lauréats de toutes les promotions ETHSUN 2026 (CAPIMMO, CBA, Gouvernance, Immobilier, Éthique, Gestion d'Entreprise, Industries Extractives), familles et proches des diplômés, partenaires institutionnels et entreprises, intervenants et corps professoral ETHSUN, media et presse.",
    schedule: [
      { time: '09h00', title: 'Accueil des familles, proches et invités — Hall d\'honneur Sofitel' },
      { time: '10h00', title: 'Cortège académique — Entrée officielle des diplômés en tenue de cérémonie' },
      { time: '10h30', title: 'Hymne de l\'Institut et ouverture solennelle de la cérémonie' },
      { time: '10h45', title: 'Allocution du Président — M. Jean-Calvin ETHIEN, Gérant ETHSUN Institute' },
      { time: '11h15', title: 'Allocution des partenaires et représentants institutionnels' },
      { time: '11h30', title: 'Remise des Certificats CAPIMMO — 18ème Promotion' },
      { time: '12h00', title: 'Remise des Certificats Executive CBA — 1ère Promotion' },
      { time: '12h30', title: 'Remise des certificats — Gouvernance, Éthique, Immobilier, Gestion d\'Entreprise' },
      { time: '13h00', title: 'Déjeuner de gala — Networking alumni & partenaires' },
      { time: '15h00', title: 'Témoignages des lauréats — Parcours et impact professionnel' },
      { time: '15h30', title: 'Remise des distinctions d\'excellence — Meilleur étudiant par promotion' },
      { time: '16h00', title: 'Séance photos officielles par promotion — Esplanade Sofitel' },
      { time: '17h00', title: 'Cocktail de clôture — Célébration avec familles et amis' },
    ],
    contact: ['(+225) 05 45 61 30 35'],
    partners: [
      'ETHSUN Executive Education Oxford',
      'Partenaires institutionnels 2026',
    ],
  },
];
