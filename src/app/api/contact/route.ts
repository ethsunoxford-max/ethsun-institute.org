...
Notre équipe vous contactera dans les meilleurs délais (sous 24h ouvrées).

Votre demande :
- Objet : ${subject}
${programme ? `- Programme d'intérêt : ${programme}` : ''}

Pour toute urgence, vous pouvez nous joindre directement sur WhatsApp : +447424201585

Cordialement,
L'équipe ETHSUN Institute
formation@ethsun-institute.org | +225 05 45 61 30 35

---
ETHSUN INSTITUTE — Per Doctrinam Excelsior
www.ethsun-institute.org | sous licence ETHSUN EXECUTIVE EDUCATION OXFORD
      `.trim();
      ...
      await fetch('https://api.brevo.com/v3/smtp/email', {
        ...
        body: JSON.stringify({
          ...
          htmlContent: `<div style="font-family:sans-serif;font-size:14px;line-height:1.8;max-width:600px;margin:auto">
            ...
            <div style="padding:32px;background:#fff">
              ...
              <div style="background:#f8f9fa;border-left:4px solid #C9A84C;padding:16px;margin:20px 0;border-radius:4px">
                ...
                ${f'<p style="margin:4px 0 0;font-size:13px"><strong>Programme :</strong> {programme}</p>' if programme else ''}
              </div>
