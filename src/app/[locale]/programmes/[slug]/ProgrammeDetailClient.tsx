        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              {programme.image && (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative w-full h-64 lg:h-80 rounded-2xl overflow-hidden shadow-lg">
                  <Image
                    src={programme.image}
                    alt={programme.title}
                    fill
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-ethsun-navy/60 to-transparent" />
                  <div className="absolute bottom-4 left-4">
                    <span className="bg-ethsun-gold text-white text-xs font-bold px-3 py-1 rounded-full">{programme.certificateLevel}</span>
                  </div>
                </motion.div>
              )}
